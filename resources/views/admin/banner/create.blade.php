            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form class="row g-3 needs-validation theme-form" action="{{ route('banner.store')}}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    <label>Unggah Infografis<span>*</span></label>
                                    <input class="form-control" type="file" placeholder="Nama URL" name="image" id="image"
                                        autocomplete="image" accept="image/*" required>
                                    @error('image')
                                        <div class="is-invalid">
                                            <span class="text-danger">
                                                {{$message}}
