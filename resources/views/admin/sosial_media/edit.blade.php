                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Platform" name="platform" value="{{$sosmed->platform}}" required>
                                        @error('platform')
                                ...
                                <div class="col-lg-12">
                                    <div class="email-wrapper">
                                        <div class="theme-form">
                                            ...
                                            <textarea id="embed_code" name="embed_code" class="form-control form-control-solid">{!! $sosmed->embed_code !!}</textarea>
                                            @error('embed_code')
