                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation theme-form"
                            action="{{ route('pejabat.update', $pejabat->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                <label> Nama Pejabat</label>
                                <input class="form-control" type="text" placeholder="Nama Pejabat" name="name" id="name"
                                    autocomplete="name" required value="{{$pejabat->name}}">
                                @error('name')
                            ...
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                ...
                                <select class="form-select js-example-basic-single col-sm-12" name="group_id" id="group_id">
                                    @foreach($group as $data)
                                        <option value="{{ $data->id }}" {{ $data->id == $pejabat->group_id ? 'selected' : '' }}>
                                            {{ $data->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                ...
                                <select class="form-select js-example-basic-single col-sm-12" name="bidang_id"
                                    ...
                                    @foreach($bidang as $data)
                                        <option value="{{ $data->id }}" {{ $data->id == $pejabat->bidang_id ? 'selected' : '' }}>
                                            {{ $data->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" type="file" name="path" id="path" autocomplete="path"
                                    accept="image/*">
                                @error('path')
                                    <div class="is-invalid">
                                        <span class="text-danger">
                            ...
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                ...
                                <input class="form-control" type="text" placeholder="Pendidikan S1" name="s1" id="s1"
                                    autocomplete="s1" required value="{{$pejabat->s1}}">
                                @error('s1')
                                    <div class="is-invalid">
                                        <span class="text-danger">
                                            {{$message}}
                            ...
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                <label>Email</label>
                                <input class="form-control" type="email" placeholder="Email Pejabat" name="email" id="email"
                                    autocomplete="email" required value="{{$pejabat->email}}">
                                @error('email')
                                    <div class="is-invalid">
                                        <span class="text-danger">
                                            {{$message}}
