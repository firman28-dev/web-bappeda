            ...
            <div class="row">
                <div class="col-lg-6 mb-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-solid rounded rounded-4"
                            placeholder="Masukkan nama menu" required name="title" id="title" autocomplete="title">
                        @error('title')
                ...
                <div class="col-lg-6 mb-4">
                    <div class="form-group">
                        ...
                        <select id="bidang_id" name="bidang_id" aria-label="Default select example"
                            class="form-select form-select-solid rounded rounded-4" required autocomplete="bidang_id">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="form-group">
                        ...
                        <select id="status_id" name="status_id" aria-label="Default select example"
                            class="form-select form-select-solid rounded rounded-4" required autocomplete="status_id">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form class="row needs-validation theme-form" novalidate="" id="pageSystemForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select js-example-basic-single col-sm-12" name="bidang_id"
                                            id="bidang_id">
                                            @foreach($bidang as $data)
                                                <option value="{{ $data->id }}">
                                                    {{ $data->label }}
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select js-example-basic-single col-sm-12" name="category_id"
                                            id="category_id">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" placeholder="Nama URL" name="image"
                                            id="image" autocomplete="image" accept="image/*">
                                        @error('image')
                                            <div class="is-invalid">
                                                <span class="text-danger">
                                                    {{$message}}
                                    ...
                                    <div class="email-wrapper">
                                        <div class="theme-form">
                                            ...
                                            <textarea id="description" name="description"
                                                class="form-control form-control-solid" rows="10"></textarea>
                                            @error('description')
                                                <div class="is-invalid">
                                                    <span class="text-danger">
                                                        {{$message}}
