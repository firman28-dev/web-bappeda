                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                @foreach($bidang as $data)
                                    <option value="{{ $data->id }}" {{ $data->id == $news->bidang_id ? 'selected' : '' }}>
                                        {{ $data->label }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form class="row needs-validation theme-form" novalidate="" id="pageSystemForm" action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6">
